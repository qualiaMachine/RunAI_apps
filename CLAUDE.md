...
`ocr_app/app.py`, `ocr_app/scripts/ocr_server.py`, and `ocr_app/scripts/batch_extract.py`
are legacy per-page paths being phased out. Do not add them to docs or
advertise them — only the chunk-based notebook pipeline is documented.

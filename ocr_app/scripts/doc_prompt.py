  ...
  "tables": [
    {
      ...
      "chunk_relative_page_index": <integer or null — the value of N from the image header label "[PAGE IMAGE N of M — PDF page X]" for the page where this item starts. Copy N (the small index in this chunk), NOT X, NOT visual_page_number. See CHUNK_RELATIVE_PAGE_INDEX rule below.>,
